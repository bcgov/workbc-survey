...
export const sendReminder = async (
  ...
  try {
    ...
    let recipients = await getReminderRecipients(
      interval,
      surveyType,
      reminder,
    );
    ...
    console.log(
      `Sending ${recipients.count} survey reminder for ${interval} days for ${surveyType}`,
    );
    let counter = 0;
    let tokenCounter = 0;
