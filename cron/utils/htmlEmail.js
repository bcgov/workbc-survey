...
module.exports = function (title, mainContent, boxContent, endContent) {
  var html = /*html*/`
    ...
    <table class="container" border="0" cellpadding="0" cellspacing="0" style="font-family: Calibri, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%;">
      <tbody>
        <tr>
              ...
              <table align="center">
                <tbody>
                  <tr>
                    <td width="600">
            <![endif]-->
            <table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family: Calibri, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%; max-width: 600px; margin: 0 auto;">
              <tbody>
                <tr>
                  <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 15px; margin: 0;" align="left">
                    
    
      <table class="card " border="0" cellpadding="0" cellspacing="0" style="font-family: Calibri, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; width: 100%; overflow: hidden; border: 5.5px solid #FCBA19;padding: 9.75pt 9.0pt 9.0pt 9.0pt" bgcolor="#ffffff">
      <tbody>
        <tr>
          <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 15px; width: 100%; margin: 0;" align="left">
            <div>
        <img width="800" height="160" border="0" id="BC_WorkBC_Banner_Top" src="${staticURL}/WorkBCTopBannerCentered.png" alt="BC WorkBC Logo" style="height: auto; line-height: 100%; outline: none; text-decoration: none; width: 100%; max-width: 100%; border: 0 none;">
        <table class="card-body" border="0" cellpadding="0" cellspacing="0" style="font-family: Calibri, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%;">
      <tbody>
        <tr>
        ...
        if (typeof boxContent != "undefined" && boxContent != null && boxContent.length != null && boxContent.length > 0){
          html += /*html*/`
                <table class="card" border="0" cellpadding="0" cellspacing="0" style="font-family: Calibri, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; border-radius: 4px; width: 100%; overflow: hidden; border: 1px solid #111111;" bgcolor="#ffffff">
                <tbody>
                  <tr>
                    <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 15px; width: 100%; margin: 0;" align="left">
                      <div>
  ...
  html += /*html*/ `</div>
          ...
          <img border="0" width="800" height="160" id="Canada_BC_Banner_Bottom" src="${staticURL}/ProgramFundingBilingualBottomBanner.png" alt="Canada BC Funding Acknowledgement" style="height: auto; line-height: 100%; outline: none; text-decoration: none; width: 100%; max-width: 100%; border: 0 none;">
          </div>
              </td>
            </tr>
          </tbody>
